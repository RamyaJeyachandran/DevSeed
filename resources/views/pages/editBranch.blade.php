        ...
        @include('layouts.sideMenu')
                ...
                <div class="content">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <button onclick="window.location='{{ url("Branch") }}'" class="btn btn-primary shadow-md mr-2">Add Hospital</button>
                        <button onclick="window.location='{{ url("SearchBranch") }}'" class="btn btn-dark shadow-md mr-2">Go Back</button>
                    </div>
                    ...
                    <input id="txtBranchId" name="branchId" value="{{$branchDetails->branchId}}" type="hidden" class="form-control">
                                    ...
                                    <div class="mt-3">
                                        <button id="btnEditBranch" type="submit" class="btn btn-primary w-24 ml-2">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog"> <div class="modal-content"> <div class="modal-body p-0"> 
                <div class="p-5 text-center"> <i data-lucide="check-circle" class="w-16 h-16 text-success mx-auto mt-3"></i>
                 <div id="divMsg" class="text-3xl mt-5"><span></span></div>  </div>
                  <div class="px-5 pb-8 text-center"> <button id="btnbrRedirect" type="button" data-tw-dismiss="modal" class="btn btn-primary w-24">Ok</button>
                 </div> 
                </div> 
            </div> 
        </div> 
