...
class HospitalBranch extends Model
{
    ...
    public function getAllHospitalBranch($hospitalId,$pagination)
    {
        ...
        $where_sts="hospitalBranch.is_active=1 ".(($hospitalId==NULL?"":" and hospitalBranch.hospitalId=".$hospitalId))." ".(($pagination['filters_field'] =="" || $pagination['filters_value']=="")?"":" and  hospitalBranch.".$pagination['filters_field']." ".$pagination['filters_type']." '".$pagination['filters_value']."%'");
    ...
    public static function getHospitalList(){
        return DB::table('hospitalsettings')->select('id','hospitalName')->where('is_active','=',1)->get();
    }
